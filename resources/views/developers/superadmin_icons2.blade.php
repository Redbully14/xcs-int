...
@section('content')
  <div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title"> Font awesome icons </h3>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/superadmin">SuperAdmin</a></li>
          <li class="breadcrumb-item active" aria-current="page">Font awesome icons</li>
        </ol>
      </nav>
    </div>
  <div class="row">
