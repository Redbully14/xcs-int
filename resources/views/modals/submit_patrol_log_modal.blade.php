            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="form-check form-check-info">
                      <label class="form-check-label"><input type="checkbox" id="flag-patrol-log"> Flag Patrol Log <i class="input-helper"></i><i class="input-helper"></i> <button class="btn btn-outline-secondary" style="padding: 2px;" data-toggle="tooltip" data-placement="bottom" title="By flagging your Patrol Log, you are indicating to staff that you would like your Patrol Log reviewed." disabled>?</button></label>
