    ...
    <div class="container-fluid documentation">
        <div class="row">
          <div class="col-md-3 col-xl-2 left-sidebar">
            ...
            <h5 class="left-menu-title">Framework</h5>
            <ul class="left-menu">
                <li><a href="#introduction"> Introduction </a></li>
                <li><a href="#progress"> Progress </a></li>
            </ul>            
            <a class="d-block mt-4 text-muted" target="_blank" href="/">Go to Dashboard</a>
          </div>
          <div class="col-md-9 col-xl-10 main-panel">
            <div class="main-panel-wrapper">
              <div class="row">
                <div class="col-12 mb-4">
                  <h2 class="mt-2 text-center font-weight-light text-uppercase">XCS-INT FRAMEWORK</h2>
                </div>
                <div class="col-12 grid-margin" id="introduction">
                  <div class="card">
                      <div class="card-body">
                          <h3 class="mb-4">Introduction</h3>
                          <p>XCS-Int is a localized framework that creates a setup enviroment for the Department of Justice Roleplay community.</p>
                          <p class="d-inline"><strong>Author</strong>: Oliver G.</p>
                      </div>
                  </div>
                </div>
                <div class="col-12 grid-margin" id="progress">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <div class="progress">
                            <div class="progress-bar bg-info progress-bar-striped progress-bar-animated" style="width:87%">87%</div>
                          </div><br>
